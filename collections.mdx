...
<Steps>
  ...
  <Step title="Step 2 - Assign floors and units">
    ...
    The collection name shown beneath a unit indicates its current assignment. A unit can belong to one collection at a time. If a selected unit already belongs to another collection, applying the new collection moves it automatically.
  ...
  <Step title="Step 4 - Set the order and share a link">
    ...
    <Frame caption="Screenshot placeholder 4: collection list, order, unit count, and actions">
      <div style={{ padding: "48px 24px", textAlign: "center", background: "#f7f8fa" }}>
        <strong>Screenshot to be added by Marios</strong><br />
        Capture multiple collection rows with their unit counts and Assign units, Copy link, Edit, and Delete actions.
      </div>
    </Frame>
  </Step>
...
- **Assign units**: add every unit on a floor or choose individual units, then apply the collection in one action.
