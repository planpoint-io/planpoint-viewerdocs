...
<Steps>
  <Step title="Open Spotlight configuration">
    ...
    <Frame caption="Spotlight General configuration">
      <img src="/images/spotlight/configuration.png" alt="Spotlight General configuration with Pinpoints editing, Pinpoints color, Spotlight URL, and Embed code" />
    </Frame>
  ...
  <Step title="Place pins on the exterior">
    ...
    <Frame caption="Spotlight pin editor">
      <img src="/images/spotlight/pin-editor.png" alt="Spotlight pin editor with exterior selectors, pins, Pin color, Pin size, and Save" />
    </Frame>
  ...
  <Step title="Choose and review each target">
    ...
    <Frame caption="Select a target for the pinpoint">
      <img src="/images/spotlight/target-picker.png" alt="Spotlight target picker showing floors, units, and the Delete pinpoint action" />
    </Frame>
...
The Spotlight URL must include the `spotlight=true` query parameter. If you build the URL in code, append the parameter to the regular viewer URL.
...
<Frame caption="Add the Spotlight parameter to a viewer URL">
  <img src="/images/spotlight/spotlight-parameter.png" alt="Code editor showing a Planpoint viewer URL with the spotlight=true parameter" />
</Frame>
...
<Frame caption="Desktop Spotlight viewer">
  <img src="/images/spotlight/desktop-viewer.png" alt="Desktop Spotlight viewer with an exterior image, unit pins, filters, and inventory cards" />
</Frame>
...
<Frame caption="Mobile Spotlight viewer and filters">
  <img src="/images/spotlight/mobile-filters.png" alt="Mobile Spotlight viewer with a selected pin, unit card, and open Filters sheet" />
</Frame>
